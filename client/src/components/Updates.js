    ...
    <div className="updates">
      <div className="d-flex justify-content-center">
        <div className="commentsArea">
          ...
          {authData.user.role !== 'Customer Service Rep' ? <textarea
      ...
      {authData.user.role !== 'Customer Service Rep' ? (<><div className="d-flex justify-content-center">
        <button
